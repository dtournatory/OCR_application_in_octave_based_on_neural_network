...
load('./2_what_character_is_it_NN2_3layers_training/Theta_NN2/Theta2_NN2.m');
load('./2_what_character_is_it_NN2_3layers_training/Theta_NN2/lkup');
...
fprintf('\nNN2 3 layers accuracy on TRAINING SET: %f\n', mean(double(p == y_integer)) * 100);
...
fprintf('\nNN2 3 layers accuracy on CROSS VALIDATION set: %f\n', mean(double(p == y_integer)) * 100);
...
fprintf('\nNN2 3 layers accuracy on TEST SET: %f\n', mean(double(p == y_integer)) * 100);
